...
async fn main() {
    ...
    tokio::spawn(async move { 
        ...
        // this lets you send events to topics (which will be sent to all clients subscribed to that topic)
        let event_emitter = server.get_event_emitter();
        // only one topic notifier can be created
        // this will receive notifications about topics being created and removed
